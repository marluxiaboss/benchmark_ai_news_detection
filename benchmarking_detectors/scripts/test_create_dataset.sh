...
python create_dataset.py generation=generation_base watermark=watermark_kgw_p generation.dataset_size=30 generation.experiment_name=test_new_watermarking
