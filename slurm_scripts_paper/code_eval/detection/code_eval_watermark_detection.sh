...
watermark_schemes=("watermark_sweet_p")
...
gen_experiment_name="final_table_high_quality"
dataset_name="humaneval"

target_fpr=0.05
detection_experiment_name="final_table_high_quality_tpr_at_5"

for i in ${!watermark_schemes[@]}; do
    watermark_scheme=${watermark_schemes[$i]}
    print_current_time
