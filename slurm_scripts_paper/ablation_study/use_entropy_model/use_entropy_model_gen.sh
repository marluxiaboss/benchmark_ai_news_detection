...
#use_entropy_model_values=("False" "True")
use_entropy_model_values=("False")
#bias_values=(10.0)
...
for i in ${!use_entropy_model_values[@]}; do
    use_entropy_model=${use_entropy_model_values[$i]}
    experiment_name="use_entropy_model_variation_${use_entropy_model}"
    ...
    echo "Use entropy model: $use_entropy_model"
