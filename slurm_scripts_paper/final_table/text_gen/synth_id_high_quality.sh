...
watermark_scheme="watermark_synth_id"
...
#ngram_len=2
keys="[654,400,836,123,340,443,597,160,57,29,590,639,13,715,468,990,966,226,324,585,118,504,421,521,129]"
ngram_len=2


experiment_name="final_table_test_ngram_len_keys_1"
...
create_dataset generation=$attack watermark=$watermark_scheme generation.generator_name=$generator_name \
        ...
        watermark.ngram_len=$ngram_len watermark.keys=$keys
