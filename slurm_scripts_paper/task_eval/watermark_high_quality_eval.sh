#!/bin/bash
#SBATCH --job-name=benchmark_watermark_task_high_quality
...
#watermarking_schemes=("SynthID" "SWEET_P" "KGW_high_quality" "SWEET_high_quality")
watermarking_schemes=("KGW_high_quality" "SWEET_high_quality")

for i in ${!watermarking_schemes[@]}; do

    watermarking_scheme=${watermarking_schemes[$i]}
    print_current_time
