...
gen_experiment_name="final_table_test_p_ratio_0_15"
...
for i in ${!temperatures[@]}; do
    ...
    gen_experiment_name="temperature_variation_test_$temperature"
    detection_experiment_name="temperature_variation_test_tpr_at_5_$temperature"
